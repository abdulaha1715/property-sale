                ...
                <div class="px-4 py-5 text-left bg-gray-300 my-5">
                    ...
                    <form action="{{ route('property-inquiry', $property->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="">
                            ...
                            <input class="w-full inputField" type="text" id="name" name="name" placeholder="First Name" value="{{old('name')}}" required>
                        ...
                        <div class="mt-5">
                            ...
                            <input class="w-full inputField" type="text" id="phone" name="phone" placeholder="Phone" value="{{old('phone')}}" required>
                        ...
                        <div class="mt-5">
                            ...
                            <input class="w-full inputField" type="email" id="email" name="email" placeholder="E-mail" value="{{old('email')}}" required>
                        ...
                        <div class="mt-5">
                            ...
                            <textarea class="w-full inputField" id="message" name="message" rows="4" placeholder="I'm interested in this property" required>{{old('message')}}</textarea>
