                ...
                <form action="{{ route('create-property') }}" method="post" class="p-6 bg-white border-b border-gray-200"> @csrf
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <input type="text" name="name" id="name" class="property-input">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input type="text" name="name_tr" id="name_tr" class="property-input">
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <select name="location_id" id="location_id" class="property-input">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input type="number" name="price" id="price" class="property-input">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select name="sale" id="sale" class="property-input">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <select name="type" id="type" class="property-input">
                    ...
                    <div class="flex -mx-4 mb-6">
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <input type="number" name="net_sqm" id="net_sqm" class="property-input">
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea name="overview" id="overview" cols="30" rows="3" class="property-input"></textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea name="overview_tr" id="overview_tr" cols="30" rows="3" class="property-input"></textarea>
                    ...
                    <div class="flex -mx-4 mb-6">
                        <div class="flex-1 px-4">
                            ...
                            <textarea name="description" id="description" cols="30" rows="10" class="property-input"></textarea>
                        ...
                        <div class="flex-1 px-4">
                            ...
                            <textarea name="description_tr" id="description_tr" cols="30" rows="10" class="property-input"></textarea>
